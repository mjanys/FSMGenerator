...
import cz.fsmgen.gui.InfoPanel;
...
public class BasicGraphEditor extends JPanel {
    ...
    public BasicGraphEditor(String appTitle, mxGraphComponent component) {
        ...
        JSplitPane center_left = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, inner,
                graphComponent);
        center_left.setOneTouchExpandable(true);
        center_left.setDividerLocation(200);
        center_left.setDividerSize(6);
        center_left.setBorder(null);
        
        rightPanel =  new JSplitPane(JSplitPane.VERTICAL_SPLIT, propertiesPanel,
                infoPanel);
        rightPanel.setResizeWeight(0.5);
        rightPanel.setDividerSize(0);
        // Creates the outer split pane that contains the inner split pane and
        // the graph component on the right side of the window
        JSplitPane outer = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, center_left,
                rightPanel);
        outer.setOneTouchExpandable(true);
//        outer.setEnabled(false);
        outer.setResizeWeight(0.8);
        outer.setDividerLocation(660);
