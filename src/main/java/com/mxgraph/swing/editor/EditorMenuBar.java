...
public class EditorMenuBar extends JMenuBar {
    ...
    public EditorMenuBar(final BasicGraphEditor editor) {
        ...
        menu.add(editor.bind(mxResources.get("new"), new NewAction(true), "/com/mxgraph/swing/images/new.gif"));
        menu.add(editor.bind(mxResources.get("openFile"), new OpenAction(), "/com/mxgraph/swing/images/open.gif"));

        menu.addSeparator();

        menu.add(editor.bind(mxResources.get("save"), new SaveAction(false), "/com/mxgraph/swing/images/save.gif"));
        ...
        menu.add(editor.bind(mxResources.get("print"), new PrintAction(), "/com/mxgraph/swing/images/print.gif"));
        ...
        menu.add(editor.bind(mxResources.get("undo"), new HistoryAction(true), "/com/mxgraph/swing/images/undo.gif"));
        menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false), "/com/mxgraph/swing/images/redo.gif"));

        menu.addSeparator();

        menu.add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(), "/com/mxgraph/swing/images/cut.gif"));
        menu.add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(), "/com/mxgraph/swing/images/copy.gif"));
        menu.add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/com/mxgraph/swing/images/paste.gif"));

        menu.addSeparator();

        menu.add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(), "/com/mxgraph/swing/images/delete.gif"));
...
//        menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/com/mxgraph/swing/images/house.gif"));
//
//        menu.addSeparator();
//
//        menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/com/mxgraph/swing/images/up.gif"));
//        menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(),
//                "/com/mxgraph/swing/images/down.gif"));
//
//        menu.addSeparator();
//
//        menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/com/mxgraph/swing/images/group.gif"));
//        menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(),
//                "/com/mxgraph/swing/images/ungroup.gif"));
//
//        menu.addSeparator();
//
...
//                "/com/mxgraph/swing/images/collapse.gif"));
//        menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/com/mxgraph/swing/images/expand.gif"));
//
//        menu.addSeparator();

        menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/com/mxgraph/swing/images/toback.gif"));
        menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(),
                "/com/mxgraph/swing/images/tofront.gif"));
...
//                "/com/mxgraph/swing/images/straight.gif"));
//
//        submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/com/mxgraph/swing/images/connect.gif"));
//        submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"),
//                "/com/mxgraph/swing/images/vertical.gif"));
//
//        submenu.addSeparator();
//
//        submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"),
//                "/com/mxgraph/swing/images/entity.gif"));
//        submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/com/mxgraph/swing/images/arrow.gif"));
//
//        submenu.addSeparator();
//
...
//                "/com/mxgraph/swing/images/open_start.gif"));
...
//        submenu.add(editor.bind(mxResources.get("size"), new PromptValueAction(mxConstants.STYLE_ENDSIZE, "Lineend Size")));
        ...
        submenu.add(editor.bind(mxResources.get("top"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_TOP),
                "/com/mxgraph/swing/images/top.gif"));
        submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
                "/com/mxgraph/swing/images/middle.gif"));
        submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM),
                "/com/mxgraph/swing/images/bottom.gif"));
