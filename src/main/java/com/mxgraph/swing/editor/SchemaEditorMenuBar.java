...
import com.mxgraph.swing.editor.EditorActions.BackgroundAction;
import com.mxgraph.swing.editor.EditorActions.BackgroundImageAction;
import com.mxgraph.swing.editor.EditorActions.ExitAction;
import com.mxgraph.swing.editor.EditorActions.GridColorAction;
import com.mxgraph.swing.editor.EditorActions.GridStyleAction;
...
import com.mxgraph.swing.editor.EditorActions.PageBackgroundAction;
import com.mxgraph.swing.editor.EditorActions.PageSetupAction;
import com.mxgraph.swing.editor.EditorActions.PrintAction;
import com.mxgraph.swing.editor.EditorActions.PromptPropertyAction;
import com.mxgraph.swing.editor.EditorActions.SaveAction;
import com.mxgraph.swing.editor.EditorActions.ScaleAction;
import com.mxgraph.swing.editor.EditorActions.SelectShortestPathAction;
import com.mxgraph.swing.editor.EditorActions.SelectSpanningTreeAction;
import com.mxgraph.swing.editor.EditorActions.StylesheetAction;
import com.mxgraph.swing.editor.EditorActions.ToggleDirtyAction;
import com.mxgraph.swing.editor.EditorActions.ToggleGridItem;
import com.mxgraph.swing.editor.EditorActions.ToggleOutlineItem;
import com.mxgraph.swing.editor.EditorActions.TogglePropertyItem;
import com.mxgraph.swing.editor.EditorActions.ToggleRulersItem;
import com.mxgraph.swing.editor.EditorActions.WarningAction;
import com.mxgraph.swing.editor.EditorActions.ZoomPolicyAction;
...
public class SchemaEditorMenuBar extends JMenuBar
{
	...
	public SchemaEditorMenuBar(final BasicGraphEditor editor)
	{
		...
		menu.add(editor.bind(mxResources.get("new"), new NewAction(true),
		...
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true),
				"/com/mxgraph/swing/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"),
				new PageSetupAction(),
				"/com/mxgraph/swing/images/pagesetup.gif"));
		...
		menu.add(editor.bind(mxResources.get("cut"), TransferHandler
				.getCutAction(), "/com/mxgraph/swing/images/cut.gif"));
		menu.add(editor
				...
				.add(editor
						.bind(
								...
								new StylesheetAction(
										"/com/mxgraph/swing/resources/basic-style.xml")));
		submenu
				.add(editor
						.bind(
